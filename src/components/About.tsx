  ...
  return (
    <section id="about" className="py-20 sm:py-28 bg-[#F3F4F6] dark:bg-[#000000] border-y border-neutral-300 dark:border-neutral-800 scroll-mt-16 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-stretch pt-2">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 flex flex-col justify-between space-y-5 text-neutral-700 dark:text-neutral-300 leading-relaxed text-sm sm:text-base font-normal"
          >
            <div className="space-y-5">
              <p>
                I am a passionate Full Stack Developer and Computer Science Engineering Student at Lovely Professional University (LPU) with a strong foundation in modern web technologies. I specialize in building end-to-end web applications with React, Next.js, Node.js, Express, MongoDB, and TypeScript.
              </p>
              ...
              <p>
                Beyond engineering, I actively participate in coding competitions like CodeClash and complete proctored certifications (Coding Tantra DSA, Infosys Springboard).
              </p>
            </div>

            {/* Core Focus Cards */}
            <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
              <motion.div 
                whileHover={{ y: -4, transition: { duration: 0.2 } }}
                className="p-4.5 rounded-2xl bg-white dark:bg-[#0D0D0D] border-2 border-neutral-300 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-500 flex items-start space-x-3.5 shadow-md hover:shadow-xl transition-all duration-300 ease-out h-full"
              >
          ...
          <motion.div 
            ...
            className="lg:col-span-5 group bg-white dark:bg-[#0D0D0D] rounded-3xl p-7 sm:p-8 border-2 border-neutral-300 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-500 shadow-md hover:shadow-2xl transition-all duration-300 ease-out transform hover:-translate-y-2 flex flex-col justify-between space-y-7 cursor-default h-full"
          >
            {/* Top Badge */}
            <div className="inline-block">
            ...
            {/* Timeline List */}
            <div className="space-y-7 relative before:absolute before:inset-0 before:left-2 before:w-0.5 before:bg-neutral-300 dark:before:bg-neutral-800 group-hover:before:bg-neutral-400 transition-colors">
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-extrabold px-2 py-0.5 rounded-full bg-violet-100 dark:bg-violet-950 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-800">
                    CGPA: 8.53
                  </span>
                </div>

                <h3 className="text-base sm:text-lg font-bold text-neutral-950 dark:text-white group-hover:text-black dark:group-hover:text-white tracking-tight transition-colors">
              ...
              >
                <motion.div 
                  ...
                  className="absolute left-[5px] top-1.5 w-2 h-2 rounded-full bg-emerald-500 ring-4 ring-emerald-100 dark:ring-emerald-950" 
                />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-extrabold px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                    82.2%
                  </span>
                </div>
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-extrabold px-2 py-0.5 rounded-full bg-sky-100 dark:bg-sky-950 text-sky-700 dark:text-sky-300 border border-sky-200 dark:border-sky-800">
                    87.2%
                  </span>
                </div>
