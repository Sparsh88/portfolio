...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="pt-32 sm:pt-36 pb-20 sm:pb-28 bg-[#F3F4F6] dark:bg-[#000000] overflow-hidden scroll-mt-16 transition-colors duration-300 relative">
      <motion.div 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          >
            ...
            >
              <a
                href="#about"
                className="inline-flex items-center space-x-2 text-xs font-semibold text-neutral-500 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors group cursor-pointer"
              >
                <span className="uppercase tracking-widest text-[10px]">Scroll down to explore</span>
                <motion.span
                  animate={{ y: [0, 4, 0] }}
                  transition={{ repeat: Infinity, duration: 1.6, ease: "easeInOut" }}
                  className="w-5 h-5 rounded-full bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center group-hover:bg-black group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black transition-colors"
                >
